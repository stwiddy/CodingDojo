var beeArray = [" Barry! Breakfast is ready!",
"Coming!",
",Hang on a second.",
",Hello?",
",Barry?",
...
var randomQuote = beeArray[Math.floor(Math.random() * beeArray.length)];
console.log ("Here is your randomly generated bee movie quote = " + "'" + randomQuote + "'")